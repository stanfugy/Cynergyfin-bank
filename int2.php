    ...
    <div class="col-lg-9">
        <div class="profile-content">
          ...
          <ul class="nav nav-pills">
            ...
            <li class="nav-item">
              <a class="nav-link active" id="step_bar_two" href="#" style="font-size: 10px; font-weight: bold">Account</a>
            </li>
            <li class="nav-item">
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <form id="send-money" method="post" action="" class="form bg-offwhite">
                ...
                <div class="text-center">
                  <h3 class="text-5 msg-header">You're sending money to <?php echo $_SESSION['t']['uf_account_name']; ?>
</h3>
                ...
                <!--</div>-->
                      ...
                      <div style="margin-left:10px; font-size:15px; line-height:25px; margin-top: 10px;">
                        <p class="total-blance">Account No. &mdash; <span id="trsmy_acct_no"><?php echo $account_number; ?></span></p>
                        <p class="total-blance">Account Category &mdash; <span id="trsmy_acct_category">Current Account</span></p>
                        <p class="total-blance">Available Balance &mdash; <span id="trsmy_acct_amt"><?php echo $currency; ?><?php $bal = number_format(floatval($balance)); echo $bal;  ?>.00 </span></p>
                      </div>           
                                        </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text currency-icon trsmy_acct_curr"><?php echo $currency; ?></span></div>
                                                <input type="text" class="form-control number" required name="uf_transfer_amt"  placeholder="Enter Amount" autocomplete="off" value=""  />       
                        <div id="uf_error_transfer_amt" class="uf_error_in"></div>
                      </div>
                                        </div>
                    <div class="form-group">
                                            <label for="description">Purpose of Payment*</label>
                      <textarea class="form-control p-3" rows="5" id="uf_transfer_remark" name="uf_transfer_remark" placeholder="Payment Description" required  onkeyup="return remove_field_validation('uf_error_transfer_remark');"></textarea>
                  <div id="uf_error_transfer_remark" class="uf_error_in"></div>
                                        </div>
                                        <div class="form-group">
                                            <label for="paymentDue">Transfer Date*</label>
                                            <div class="position-relative">
                                                <input id="paymentDue" value="" required name="paymentDue" type="text" class="form-control" placeholder="Payment Date" onclick="return remove_field_validation('uf_error_paymentDue');">
           ...
           <!--                             </div>-->
                                           <ul class="pager mt-4">
                                            ...
                                            <li>
                                                <button class="btn btn-default mr-0" type="submit" name="submit">
                                                    <span class="bh"></span>
                                                    <span>Continue</span>
