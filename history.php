                                        ...
                                        if (isset($his)){
                                            foreach ($his as $user) {
                                                ...
                                                ?>
							  							 ...
							  							 <div class="items">
							  	<?php if ($status === "Debit") { ?>
								<a href="debit.php?history_id=<?php echo $history_id; ?>"> <?php } ?>

									<?php if ($status === "Credit") { ?>
								<a href="credit.php?history_id=<?php echo $history_id; ?>"> <?php } ?>

									<div class="row">
										<div class="col pay-date">
											<!-- <span class="date">05</span> -->
											<span class="pay-month"><?php echo $trans_date; ?></span>
										</div>
										<div class="col">
											<span class="name"><?php 	echo $trans_discrip; ?></span></div>
										<div class="col text-center">
														
																							<?php 	if ($status === "Debit") { ?>
																							<span class="payments-status" data-toggle="tooltip" data-original-title="Debit" style="background: #e4297c; color: #ffffff; border-radius: 12px;">Debit</span>
																						<?php } ?>

																							<?php 	if ($status === "Credit") { ?>
																							<span class="payments-status" data-toggle="tooltip" data-original-title="Credit"  style="background: #74c69d; color: #ffffff;  border-radius: 12px;">Credit</span>
																						<?php 	} ?>
										...
										<div class="col text-center">
											<span class="payment-amaount"><?php echo $currency; ?>25</span>
										</div>
										<div class="col">
											<span class="payment-amaount"><?php echo $currency; ?><?php 	$amt = number_format(floatval($amount)); echo $amt; ?> .00</span>
