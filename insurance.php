...
<!--						-->
<!--						<option value='<i class="fas fa-dollar-sign"></i> 996,534.00 USD'>USD Balance</option>-->
<!--						-->
<!--					</select>-->
<!--					<p class="total-blance" id="top_profile_cur_bal"><i class="fas fa-dollar-sign"></i> 996,534.00</p>-->
    ...
    text-align: center;
				...
				<div class="col-lg-9 col-md-9 col-sm-12">
				    <div class="profile-content">
				     <h3 class="admin-heading">INSURANCE</h3>
				    </div>
			<div class="dashboard-content">
                ...
                <div class="col-xl-12 col-lg-4 col-md-4 col-sm-6">
                      <div class="alert alert-warning borderless"  style="background: #ffffff; border-color: #329edf;">
                       <div class="element-box">
                      <form action="" method="post"><br>
                        <h5 class="element-box-header">(Please complete the form below and we will send you a competitive quote)</h5>
                        <div class="row">
                          <div class="col-sm-6">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label class="lighter" for=""
                                >How much do you plan to Insure</label
                              >
                              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                <input class="form-control" required
                        ...
                        <div class="form-buttons-w text-right compact">
                          ...
                          <center><a href="" class="btn btn-default btn-center"><span>Submit</span></a></center>
                        </div>
                      </form>
                    </div>
                  </div>
