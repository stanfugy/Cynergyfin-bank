                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="content-area">
                                                        ...
                                                        to <i class="fas fa-building"></i>
                                                        <?php   echo $sender_name; ?>                                   <p><?php  echo $trans_date; ?></p>
                                                        <p>Transaction ID: 32323<?php echo $history_id;?></p>
                            <p>Payment Status: COMPLETED</p>                                                       
                                                ...
                                                <div class="col">
                                                    <div class="content-area text-right">
                                                        <div class="price">
                                                            <b>Amount</b>
                                                            <p><?php echo $currency; ?> <?php $amt = number_format(floatval($amount)); echo $amt; ?>.00 </p>
                              <b> (Debit)</b>
                                                        </div>                                                        
                                                    </div>
                                                </div>
                                        ...
                                        <div class="table-content">
                                            <div class="row">
                                                <div class="col">
                                                    Amount:</div>
                                                <div class="col"><?php echo $currency; ?> <?php echo $amt; ?>.00 (Debit)</div>
                                                <div class="col"></div>
                                                <div class="col text-right"></div>
                                            </div>
                                        </div>
                                        <div class="table-content">
                                            <div class="row">
                                                ...
                                                <div class="col"><?php echo $currency; ?>25.00</div>
                                                <div class="col"></div>
                                                <div class="col text-right"></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                   Receiver name:</div>
                                                <div class="col"> <?php   echo $sender_name; ?>  </div>
                                                <div class="col"></div>
                                                <div class="col text-right"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-content">
                                            <div class="row">
                                                ...
                                                <div class="col" style="width: 400px;"><?php  echo $trans_discrip; ?></div>
                                                <div class="col"></div>
                                                <div class="col text-right"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-content">
                                            <div class="row">
                                                ...
                                                <div class="col"><?php echo $currency; ?><?php echo $h_balance; ?>.00</div>
                                                <div class="col"></div>
                                                <div class="col text-right"></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                  Uncleared Balance:</div>
                                                <div class="col">USD 0.00</div>
                                                <div class="col"></div>
                                                <div class="col text-right"></div>
                                            </div>
                                        </div> -->
