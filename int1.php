        ...
        <div class="profile-content">
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <form id="send-money" method="post" action="" class="form bg-offwhite">
                ...
                <div class="form-group">
                  <label for="description">Recipient's Bank Name* </label>
                 ...
                 <div class="form-group">
                  <label for="baccount">Recipient's IBAN/Account Number* </label>
                ...
                <div class="form-group">
                  <label for="bbank">Recipient's Bank BIC/Swift Code* </label>
                  <input type="text" class="form-control" name="uf_bank_btc" id="uf_bank_btc" required placeholder="" autocomplete="off" value="" onkeyup="return remove_field_validation('uf_error_bank_btc');" />        
                  <div id="uf_error_bank_btc" class="uf_error_in"></div>
                </div>

                  <div class="form-group">
                  <label for="bbank">Recipient's email* </label>
                  <input type="text" class="form-control" name="email" id="uf_bank_btc" required placeholder="" autocomplete="off" value=""  />        
                  <div id="uf_error_bank_btc" class="uf_error_in"></div>
                </div>

                 <div class="form-group">
                  <label for="bbank">Recipient's Phone* </label>
                  <input type="text" class="form-control" name="rphone" id="uf_bank_btc" required placeholder="" autocomplete="off" value=""  />        
                  <div id="uf_error_bank_btc" class="uf_error_in"></div>
                </div>

                
                <div class="form-group">
                  <label for="description">Recipient's Address* <sub>Country/State:</sub></label>
                  <textarea class="form-control p-3" rows="5" id="uf_reference" required  name="uf_reference" placeholder=""  onkeyup="return remove_field_validation('uf_error_reference');"></textarea>
                  <div id="uf_error_reference" class="uf_error_in"></div>
                </div>
